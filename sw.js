  ...
  try {
    ...
    const r = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        model: 'claude-sonnet-4-20250514',
        max_tokens: 1000,
        system: `You are a sharp, friendly personal finance assistant inside an app called Vault. Give concise, specific, actionable advice in 2-3 sentences. Plain prose only, no bullet points. Here is the user's financial data: ${JSON.stringify(context)}`,
